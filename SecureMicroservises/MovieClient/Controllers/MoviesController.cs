...
namespace MovieClient.Controllers
{
    ...
    {
        private readonly IMovieAPiServises _movieAPiServises;

        public MoviesController(IMovieAPiServises movieAPiServises)
        {
           _movieAPiServises = movieAPiServises;
        }
        ...
        {
            LogTokenAndClaims();
            return View(await _movieAPiServises.GetMoviesAsync());
        }
